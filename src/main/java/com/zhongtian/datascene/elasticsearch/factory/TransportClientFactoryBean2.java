...
public class TransportClientFactoryBean2 implements SmartFactoryBean<TransportClient> ,DisposableBean  {
	protected static final Log logger = LogFactory.getLog(TransportClientFactoryBean2.class);
