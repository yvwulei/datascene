...
<body class="login">
	...
	<div class="content">
		...
		<sf:form modelAttribute="contentModel" class="register-form" method="POST">
			<h3 >注册新账户</h3>
			<p>请输入个人信息：</p>
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="icon-font"></i>
					<sf:input path="nickname" class="form-control placeholder-no-fix" autocomplete="off" placeholder="姓名"/><br/>
					<sf:errors path="nickname" class="field-has-error"></sf:errors>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="input-icon">
					...
					<sf:input path="email" class="form-control placeholder-no-fix" autocomplete="off" placeholder="邮箱"/><br/>
					<sf:errors path="email" class="field-has-error"></sf:errors>
				</div>
			</div>	
			<p>请输入账户信息：</p>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="controls">
					<div class="input-icon">
						<i class="icon-ok"></i>
						<sf:password path="confirmPassword" class="form-control placeholder-no-fix" autocomplete="off" placeholder="确认密码"/><br/>
						<sf:errors path="confirmPassword" class="field-has-error"></sf:errors> 
					</div>
				</div>
			</div>
			<div class="form-group">
				<label>
					<sf:checkbox path="agreement"/> 我同意 <a href="#">服务条款</a> 和 <a href="#">隐私政策</a>
				</label>  
				<div id="register_agreement_error"></div>
				<sf:errors path="agreement" class="field-has-error"></sf:errors>
			</div>
